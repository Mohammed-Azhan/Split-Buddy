...
{/* 
                  ...
                  <button
                    ...
                    className="login-btn cursor-pointer relative flex w-full items-center justify-center rounded-lg px-4 py-3 mt-8 text-sm font-medium text-white transition-all duration-300"
                    disabled={loading}>
                    {loading ? (
                      <>
                ...
                <div className="mt-8 text-center text-sm">
                  <button onClick={handleRedirect} className='bg-teal-500 cursor-pointer flex items-center justify-between px-8 w-full text-white p-2 text-lg font-semibold rounded-lg'>Get me back to sign in page <ArrowRight></ArrowRight></button>
                </div>
              </div>
            </div>
          </div>
